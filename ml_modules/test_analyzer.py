...
def test_basic_analysis():
    ...
    test_data = {
        ...
        "keywords": ["Python", "Django", "Flask", "web applications", "APIs", "problem-solving", "clean code"],
    ...
    try:
        ...
        if report.get('answer_accuracy'):
            ...
            if 'keyword_coverage' in acc:
                ...
                print(f"   Keyword Coverage: {kw['matched_keywords']}/{kw['total_keywords']} ({kw['coverage_score']:.2f})")
...
def test_enhanced_session_analysis():
    ...
    session_data = {
        ...
        "keywords": ["React", "JavaScript", "components", "hooks", "state management", "UI"],
...
def test_batch_analysis():
    ...
    try:
        ...
        if batch_results.get('aggregate_insights'):
            ...
            print(f"   Score Range: {insights['lowest_score']} - {insights['highest_score']}")
