...
import {
  ...
  Building, GraduationCap, Briefcase
} from 'lucide-react';
...
const Insights = () => {
  ...
  const allTimeRangeData = {
    ...
    '3M': {
      ...
      growth: { interviews: 15.3, placements: 12.8, score: 5.2, companies: 8.9 }
    },
    '6M': {
      monthlyInterviews: [
        { month: 'Jan', interviews: 245, placements: 189, success_rate: 77 },
      ...
      growth: { interviews: 22.1, placements: 18.7, score: 7.3, companies: 12.4 }
    },
    '1Y': {
      monthlyInterviews: [
      ...
      growth: { interviews: 34.6, placements: 28.9, score: 12.1, companies: 24.8 }
    }
  };

  const currentData = useMemo(() => allTimeRangeData[selectedTimeRange], [selectedTimeRange]);
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className={`text-sm flex items-center ${change >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
      ...
      <div className="p-6 w-full h-full overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Comprehensive analytics for your placement ecosystem</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard title="Total Interviews" value={currentData.totalInterviews} change={currentData.growth.interviews} icon={Users} color="bg-purple-600" />
            <StatCard title="Successful Placements" value={currentData.totalPlacements} change={currentData.growth.placements} icon={Award} color="bg-green-600" />
            <StatCard title="Average Score" value={currentData.avgScore} change={currentData.growth.score} icon={Target} color="bg-blue-600" />
            <StatCard title="Partner Companies" value={currentData.partnerCompanies} change={currentData.growth.companies} icon={Building} color="bg-orange-600" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Interview & Placement Trends ({selectedTimeRange})</h3>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={currentData.monthlyInterviews}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="interviews" stroke="#8b5cf6" strokeWidth={3} />
            ...
            {/* Skill Distribution */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Skills in Demand</h3>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {/* College Performance */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Top Performing Colleges</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={collegePerformance}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#374151" opacity={0.3} />
                  <XAxis dataKey="college" angle={-45} textAnchor="end" height={80} />
                  <YAxis />
                  <Tooltip />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Performance by Category</h3>
              <div className="space-y-4">
                {interviewMetrics.map((metric, index) => (
                  <div key={metric.category}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium">{metric.category}</span>
                      <span className="text-sm font-bold">{metric.avg_score}/10</span>
                    </div>
...
{/* Weekly Activity and Success Rate */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {/* Daily Activity */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Weekly Interview Activity</h3>
              <ResponsiveContainer width="100%" height={250}>
                <AreaChart data={dailyActivity}>
                  ...
                  <YAxis stroke="#6B7280" />
                  <Tooltip />
                  <Area type="monotone" dataKey="interviews" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.6} />
                  <Area type="monotone" dataKey="feedback_given" stroke="#10b981" fill="#10b981" fillOpacity={0.6} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            {/* Success Rate Trend */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Placement Success Rate ({selectedTimeRange})</h3>
              <ResponsiveContainer width="100%" height={250}>
                <LineChart data={currentData.monthlyInterviews}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#374151" opacity={0.3} />
                  <XAxis dataKey="month" stroke="#6B7280" />
                  ...
                  <Line type="monotone" dataKey="success_rate" stroke="#10b981" strokeWidth={4} dot={{ r: 6 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm">
              ...
              <h4 className="text-lg font-semibold mb-2">Average Interview Time</h4>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm">
              ...
              <h4 className="text-lg font-semibold mb-2">Student Satisfaction</h4>
