...
const StudentDashboard = () => {
  ...
  // Get dark mode state from localStorage or system preference (managed by sidebar)
  ...
  // Listen for changes in localStorage to sync with sidebar theme changes
  useEffect(() => {
    ...
    // Check for theme changes periodically (fallback for same-tab changes)
      ...
      <div className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 text-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg border dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border dark:border-gray-700 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-600 dark:text-gray-400 hover:border-blue-400 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <select className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                  <option value="week">This Week</option>
                  <option value="month">This Month</option>
                  <option value="quarter">This Quarter</option>
                </select>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-sm text-green-600 dark:text-green-400">
                    You're close to unlocking the "Consistency Champion" badge!
                    Complete 3 more days of practice.
                  </p>
                </div>
                ...
                <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                  ...
                  <p className="text-sm text-orange-600 dark:text-orange-400">
                    Book more behavioral interview sessions to reach your target
                    score of 8.0/10 average.
                  </p>
                </div>
              </div>
            </div>
